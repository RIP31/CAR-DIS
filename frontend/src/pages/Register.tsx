    ...
    >
      ...
      <div className="w-full max-w-md animate-fade-in-up z-10">
        <div className="glass p-8 rounded-3xl shadow-2xl relative bg-[#0d0e12]/60 border border-white/5">
          ...
          {error && (
            <div className="mb-5 flex items-start gap-2.5 bg-rose-950/40 border border-rose-800/20 p-4 rounded-xl text-rose-200 text-xs leading-relaxed">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <User className="absolute left-4 top-3.5 h-4.5 w-4.5 text-slate-600" />
                <input
                  id="name"
                  type="text"
                  required
                ...
                <button
                  ...
                  className={`py-3 rounded-xl border text-xs font-bold uppercase tracking-wider transition-all cursor-pointer ${
                    role === 'USER'
                      ...
                      : 'bg-white/3 text-slate-400 border-white/5 hover:bg-white/5'
                  }`}
                >
                  Standard User
                </button>
          ...
          <div className="mt-6 text-center text-xs text-slate-500 font-semibold">
            ...
            <Link to="/login" className="text-teal-400 hover:text-teal-300 font-bold ml-1 transition-colors">
              Sign In
            </Link>
          </div>
        </div>
